...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppComponentsCheckoutCheckoutComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    CheckoutComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJjaGVja291dC9jaGVja291dC5jb21wb25lbnQuc2NzcyJ9 */"]
    });
    /*@__PURE__*/
      ...
      function CartService(productService, httpClient, router, spinner, toast) {
        ...
        if (info !== null && info.prodData[0].incart !== 0 && info !== undefined) {
          ...
          this.cartDataClient.prodData.forEach(function (p) {
            _this3.productService.getSingleProduct(p.id).subscribe(function (actualProdInfo) {
              if (_this3.cartDataServer.data[0].numInCart === 0) {
                _this3.cartDataServer.data[0].numInCart = p.incart;
                _this3.cartDataServer.data[0].product = actualProdInfo;

                _this3.CalculateTotal();

                _this3.cartDataClient.total = _this3.cartDataServer.total;
                localStorage.setItem('cart', JSON.stringify(_this3.cartDataClient));
              } else {
                _this3.cartDataServer.data.push({
                  numInCart: p.incart,
              ...
              _this3.cartDataObs$.next(Object.assign({}, _this3.cartDataServer));
            });
          });
        }
      }
      ...
      _createClass(CartService, [{
        ...
        value: function AddProductToCart(id, quantity) {
          ...
          this.productService.getSingleProduct(id).subscribe(function (prod) {
            ...
            if (_this4.cartDataServer.data[0].product === undefined) {
              _this4.cartDataServer.data[0].product = prod;
              _this4.cartDataServer.data[0].numInCart = quantity !== undefined ? quantity : 1;

              _this4.CalculateTotal();

              _this4.cartDataClient.prodData[0].incart = _this4.cartDataServer.data[0].numInCart;
              _this4.cartDataClient.prodData[0].id = prod.id;
              ...
              _this4.toast.success("".concat(prod.name, " added to the cart."), 'Product Added', {
                timeOut: 1500,
                progressBar: true,
            ...
            // Cart is not empty
                ...
                var index = _this4.cartDataServer.data.findIndex(function (p) {
                ...
                if (index !== -1) {
                  if (quantity !== undefined && quantity <= prod.quantity) {
                    ...
                    _this4.cartDataServer.data[index].numInCart = _this4.cartDataServer.data[index].numInCart < prod.quantity ? quantity : prod.quantity;
                  } else {
                    // @ts-ignore
                    // tslint:disable-next-line:no-unused-expression
                    _this4.cartDataServer.data[index].numInCart < prod.quantity ? _this4.cartDataServer.data[index].numInCart++ : prod.quantity;
                  }

                  _this4.cartDataClient.prodData[index].incart = _this4.cartDataServer.data[index].numInCart;

                  _this4.toast.info("".concat(prod.name, " quantity updated in the cart."), 'Product Updated', {
                    timeOut: 1500,
                    progressBar: true,
                    progressAnimation: 'increasing',
                    positionClass: 'toast-top-right'
                    ...
                    _this4.cartDataClient.prodData.push({
                      id: prod.id,
                      incart: 1
                    });
